...
BOOST_AUTO_TEST_CASE(Permute_Variable_direct) {
    auto *data_0{ new Variable::data_type[3]{ 1, 2, 3 } };;
    auto *data_1{ new Variable::data_type[3]{ 1, 3, 2 } };
    auto *data_2{ new Variable::data_type[3]{ 2, 1, 3 } };
    ...
    BOOST_ASSERT(v == v0);
    BOOST_TEST(permutation::next(v)); BOOST_ASSERT(v == v1);
    BOOST_TEST(permutation::next(v)); BOOST_ASSERT(v == v2);
}

BOOST_AUTO_TEST_CASE(Permute_Variable_copy) {
    Permutation<int> perm = {2, 1, 0};
    auto *data_3{ new Variable::data_type[3]{ 1, 2, 3 } };;
    auto *data_3_exp{ new Variable::data_type[3]{ 3, 2, 1 } };
