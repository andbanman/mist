...
// test data
auto *data_many_bin2_a{ new int[6]{ 0, 1, 1, 0, 0, 1 } };;
auto *data_many_bin2_b{ new int[6]{ 1, 1, 0, 0, 1, 0 } };;
...
static it::Distribution polymorphCount(
        it::Counter & pdc, Variable::tuple const& vars) {
