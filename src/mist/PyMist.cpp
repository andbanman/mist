...
BOOST_PYTHON_MODULE(libmist)
{
    ...
    p::class_<Search>("Search")
        ...
        .def("set_search_type", &Search::set_search_type)
        .def("set_probability_algorithm", &Search::set_probability_algorithm)
        .def("enable_cache_d1", &Search::enable_cache_d1)
        .def("enable_cache_d2", &Search::enable_cache_d2)
        .def("disable_cache_d1", &Search::enable_cache_d1)
        .def("disable_cache_d2", &Search::enable_cache_d2)
