...
class MRU : public Cache<V>
{
  ...
  //
  // Based on:
  // https://www.boost.org/doc/libs/1_65_0/libs/multi_index/example/serialization.cpp
  ...
  typedef multi_index_container<
    Element,
    indexed_by<sequenced<>, hashed_unique<member<Element, K, &Element::first>>>>
    item_list;
...
public:
  ...
  MRU()
    : max_num_items(0){};
  MRU(std::size_t max_size)
    : max_num_items(max_size){};
  MRU(MRU const& other)
    : max_num_items(other.max_num_items)
  {
    this->il = other.il;
  };
