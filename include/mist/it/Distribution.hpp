...
public:
    DistributionOutOfRange(std::string const& method, int pos, int size) :
        out_of_range("Distribution::" + method + " : Position " + std::to_string(pos) + " out of range [0," + std::to_string(size) ) { }
};
...
public:
    ...
    Distribution(Container const& strides) : factors() {
        std::size_t size = 1;
    ...
    Data const& operator[](Integer index) const { return this->data[index]; }
    template <typename Integer>
    Data & operator[](Integer index) { return this->data[index]; }
    ...
    Data const& operator()(int v0, int v1, int b0, int b1) const { return this->data[v0 + b0*v1]; };
    Data &      operator()(int v0, int v1, int b0, int b1)       { return this->data[v0 + b0*v1]; };
    Data const& operator()(int v0, int v1, int v2, int b0, int b1, int b2) const { return this->data[v0 + b0*v1 + b0*b1*v2]; };
    Data &      operator()(int v0, int v1, int v2, int b0, int b1, int b2)       { return this->data[v0 + b0*v1 + b0*b1*v2]; };
